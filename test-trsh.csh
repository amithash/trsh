...
@ TOTAL_COUNT = $TOTAL_COUNT + 1
if ( -e $HOME/.Trash/test_trsh1______0 || ! -e $HOME/.Trash/test_trsh2______0 ) then
	echo "TEST 14 FAILED: Erase specific file" 
else
	echo "TEST 14 PASSED: Erase specific file" 
	@ PASSED_COUNT = $PASSED_COUNT + 1
endif
...
if ( -e "$HOME/.Trash/~!@#$%^&*()_+______0" ) then
	...
	echo "TEST 15A FAILED: Delete Special Character Pattern A"
endif
...
if ( -e $HOME/.Trash/\`1234567890-=______0 ) then
	...
	echo "TEST 15B FAILED: Delete Special Character Pattern B"
endif
...
if ( -e "$HOME/.Trash/[]\{}|______0" ) then
	...
	echo "TEST 15C FAILED: Delete Special Character Pattern C"
endif
